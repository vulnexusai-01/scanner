...
Se você já entendeu o mecanismo mas está travado com um erro de CORS em produção agora, veja o [guia prático de correção no Node.js e no Nginx](/blog/erro-cors-como-resolver-nodejs-nginx), com exemplos prontos de allowlist e do header `Vary: Origin`.
