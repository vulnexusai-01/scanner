...
Cookies bem configurados reduzem o dano se algo der errado, mas a primeira linha de defesa é impedir que um script malicioso rode — é isso que o header [Content-Security-Policy](/blog/content-security-policy-explicada) faz.
