...
HSTS only protects well when the underlying TLS setup is also correct — it's worth checking whether the server has already [disabled the old TLS versions](/en/blog/tls-versions-tls-12-and-tls-13) before forcing HTTPS across the board.
