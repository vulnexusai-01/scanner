...
El HSTS solo protege bien cuando la base de TLS también está correcta — vale la pena revisar si el servidor ya [desactivó las versiones antiguas de TLS](/es/blog/tls-versiones-tls-12-y-tls-13) antes de forzar HTTPS en toda la navegación.
